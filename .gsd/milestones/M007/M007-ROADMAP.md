...
- [ ] **S01: Settings page Triggarr-style redesign** `risk:medium` `depends:[]`
...
- [ ] **S02: Screenshots & documentation update** `risk:low` `depends:[S01]`
...
- [ ] **S03: Tag v3.3.0 release** `risk:low` `depends:[S02]`
...
Consumes:
- Settings redesign from S01 (for accurate screenshot capture)
