...
export class AutoQueuePage extends App {
    ...
    async addPattern(pattern: string) {
        ...
        await this.page.locator('#add-pattern button.btn-outline-success').click();
    ...
    async removePattern(index: number) {
        ...
        await this.page.locator('#autoqueue .pattern').nth(index).locator('button.btn-outline-danger').click();
